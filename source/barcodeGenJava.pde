...
String digitToCode39Binary(int digit) {
  if (digit > 10 || digit < 0) {
    return "error";
  }
...
String digitToCode39Pattern(int digit) {
  if (digit > 10 || digit < 0) {
    return "error";
  }
...
void drawStartStopCode39Binary(int digitCount) {
...
void drawBarAndDigit(int digit, int digitCount) {
...
void drawBarCode(int startingNum, int numBarcodes) {
